...
import design.swing.ButtonOutLine;
...
//                event.actionPerformed(ae);
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(33, 150, 222), 0, getHeight(), new Color(42, 146, 200));
        g2.setPaint(gra);
