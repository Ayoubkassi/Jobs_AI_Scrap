...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            lbMessage.setIcon(new ImageIcon("/home/ryota/Desktop/FrontEnd/src/main/java/com/raven/success.png"));
        } else {
            lbMessage.setIcon(new ImageIcon("/home/ryota/Desktop/FrontEnd/src/main/java/com/raven/error.png"));
        }
    }
